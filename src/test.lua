...
--   assert(result and result.test and result.test.text=="b c")
   ...
   compile.compile('test = a* b', ENGINE.env)
   result = match("test", 'a b')
   assert(result and result.test and result.test.text=="a b")
   result = match("test", 'a a b')
   assert(not result)
   result = match("test", 'aaa b')
   ...
   result = match("test", 'a b')
   assert(result and result.test and result.test.text=="a b")
   result = match("test", 'aa b')
   assert(not result)
   result = match("test", 'a a a b')
   ...
   print("Testing {(a)* a? b}")
   compile.compile('test = {(a)* a? b}', ENGINE.env)
   result = match("test", 'ab')
