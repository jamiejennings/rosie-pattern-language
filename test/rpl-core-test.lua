...
---------------------------------------------------------------------------------------------------
heading("Prohibited to use keywords as identifiers")
...
ok, _, errs = e:load('alias = "foo"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local alias = "bar"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local alias alias = "bar"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local = "oklocal"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local local = "oklocallocal"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local alias local = "oklocalaliaslocal"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('grammar = "okgrammar"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('alias grammar = "okaliasgrammar"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('alias local grammar = "wrong order of declaration keywords"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local alias grammar = "oklocalaliasgrammar"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('end = "okend"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('alias end = "okaliasend"')
check(not ok)

ok, _, errs = e:load('alias local end = "wrong order of declaration keywords"')
check(not ok)
check_syntax_error(errs)

ok, _, errs = e:load('local alias end = "oklocalaliasend"')
check(not ok)
check_syntax_error(errs)
